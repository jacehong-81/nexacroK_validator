    ...
    */
    ; (function ()
    {
        ...
        define("cordova/pluginloader", function (require, exports, module)
        {
            ...
            // Handler for the cordova_plugin.js content.
            ...
            function findCordovaPath()
            {
                ...
                for (var n = scripts.length - 1; n > -1; n--)
                {
                    ...
                    if (src.toLowerCase().indexOf(term) === (src.length - term.length))
                    {
                ...
                if (path)
                {
                    var lastPath = path.substring(path.length - 8);

                    // Merge 가 되어있는 경우를 고려해서 경로를 재설정한다.
                    if (lastPath.toLowerCase() === 'cordova/')
                    {
                        path = path + '../';
                    }
                }
            ...
            exports.load = function (callback)
            {
                ...
                injectIfNecessary('cordova/plugin_list', pathPrefix + 'cordova_plugin.js', function ()
                {
        ...
        define("cordova/plugin/ios/console", function (require, exports, module)
        {
            ...
            function wrappedOrigCall(orgFunc, newFunc)
            {
                return function ()
                {
                    ...
                    try { orgFunc.apply(WinConsole, args); }
                    catch (e) { }
                    try { newFunc.apply(console, args); }
                    catch (e) { }
                };
            }
