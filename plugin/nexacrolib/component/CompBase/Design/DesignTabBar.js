...
{
    var _pTabBar = nexacro.TabBarControl.prototype;

    _pTabBar.createCssDesignContents = function ()
    {
        // TOOD : tabbar item 임의 생성 필요
    };

    _pTabBar.updatePreviewPosition = function ()
    {
        this.setOffsetHeight(100);
