if (nexacro.MainFrame)
{
    ...
    _pMainFrame.createWindow = function ()
    {
        if (!this._isPreviewMode())
        {
            ...
            {
                return _win.create(null, this._p_name, this._adjust_width, this._adjust_height, this._adjust_left, this._adjust_top, this._p_resizable);
            });
...
if (nexacro.ChildFrame)
{
    ...
    _pChildFrame.showDesign = function (str_id, _parent_frame, arr_arg, opener, _parent_handle)
    {
        ...
        if (!this._p_autosize)
        {
            ...
            this._window.attachRoot(this, false, () =>
            {
                return this._window.create(parent_window, this.id, width, height, left, top, this._p_resizable, this._p_layered, this._p_showontaskbar);
            });
            ...
            nexacro._observeSysEvent(
                ...
                "resize",
                "onresize",
                function () { if (pThis._p_form) pThis._p_form._on_designform_onsize(); });
        }
    };
