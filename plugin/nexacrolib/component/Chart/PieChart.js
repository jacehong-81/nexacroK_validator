...
if (!nexacro.PieChart)
{
    ...
    //===============================================================
    // nexacro.PieChart : Create & Update
    //===============================================================
    ...
    //===============================================================
    // nexacro.PieChart : Events
    //===============================================================


    //===============================================================
    // nexacro.PieChart : Logical part
    //===============================================================	
    ...
    //===============================================================
    // nexacro.PieChart : Util Function
    //===============================================================
...
{
    //==============================================================================
    // nexacro.ChartPieSeriesEventInfo
    //==============================================================================


    //==============================================================================
    // nexacro.ChartPieSeries
    //==============================================================================
    ...
    //============================================================
    // nexacro.ChartPieSeries : Properties
    //============================================================
    ...
    _pChartPieSeriesControl.set_fillstyle = function (v)
    {
        ...
        if (v && (typeof (v) == "string"))
        {
            ...
            if (val)
            {
                ...
                //trace("this._fillstyle", this._fillstyle);
    ...
    //============================================================
    // nexacro.ChartPieSeries : Methods
    //============================================================

    //============================================================
    // nexacro.ChartPieSeries : Logical part
    //============================================================	
    ...
    _pChartPieSeriesControl._drawPie = function ()
    {
        var chart = this._chart,
            ...
            rHighlightStartAngle = this._startangle || 0,
            rHighlightEndAngle = 0,
            maxRadius = Math.min(this._chart._boardWidth, this._chart._boardHeight) / 2,
            radius = 0,
            innerradius,
            total = 0,
            ...
            endangle = this._endangle || 6.28319,
            drawitemCnt = 0,
            effect = this._chart_aniframe_obj,
            i = 0,
            selectlength = 0,
        ...
        if (this._chart && this._chart._usepattern)
        {
            ...
            linestyle = astyle.normallinestyle;
        ...
        function drawSlice(pThis, i)
        {
            if (items[i]._isShow)
            {
                ...
                else
                {
                    ...
                    if (!items[i].isskip) // 앞뒤에 gradation 가능
                    {
                        if (!items[i].nextskip)
                        {
                            if (i == 0)
                ...
                var startAngle = Math.round(rStartAngle * 180 / Math.PI),
                    ...
                    highlightStartAngle = rHighlightStartAngle * 180 / Math.PI,
                    highlightEndAngle = rHighlightEndAngle * 180 / Math.PI,
                    w = radius,
                    h = radius,
                    p0, p1, p2, p3,
                    la,
                    ...
                    selectindent,
                    startangle = pThis._startangle || 0;
                var idx;
                var astyle;
                ...
                {
                    var highlightradius = pThis.highlightradius,
                        hRadius = 0,
                        maxRadius = Math.min(pThis._chart._boardWidth, pThis._chart._boardHeight) / 2,
                        highlightPathData;
                ...
                if (isselectitem)
                {
                    ...
                    {
                        idx = pThis._chart.getPatternIndex(i);
                        astyle = pThis._chart.getPattern(idx);
                ...
                else
                {
                    ...
                    if (pThis._chart && pThis._chart._usepattern)
                    {
                        idx = pThis._chart.getPatternIndex(i);
                        astyle = pThis._chart.getPattern(idx);
                        slice.set_fillstyle(astyle.fillstyle);
                    }
                    else
    ...
    _pChartPieSeriesControl._drawLabels = function ()
    {
        ...
        function drawLabel(item, startangle, index, pThis)
        {
            ...
            var halfAngle = 0,
                ...
                centerY = pThis._chart._centerTop,
                itemText,
                itemtextguidesize = pThis._itemtextguidesize,
                textX = 0,
                textY = 0,
                itempointsize,
                pointx,
                pointy,
                itemtextguidelinestyle = pThis.itemtextguidelinestyle,
                itemtextguidelineopacity = pThis.itemtextguidelineopacity,

                guideline,
                seriesGroup = pThis._chart._seriesGroup,
                itemtextguidelocation = pThis._itemtextguidelocation,
                itemId,
                radius,
                targetX = 0,
                targetY = 0,
            ...
            // trace(i + " startAngle", startAngle, " rStartAngle", rStartAngle, " itemendAngle", itemendAngle, " itemangle", itemangle);
            ...
            else // itemtextguidelocation == "out"
            {
            ...
            if (!nexacro._isNull(itemText))
            {
                ...
                // TODO: itemtextguidetype = bend, curve
                if (itemtextguidelocation == "out")
                {

                    var centerAngle = halfAngle * 180 / Math.PI,
                        ptPos = { x: pointx, y: pointy },
                    ...
                    guideline.moveTo(ptPos.x, ptPos.y); // pointx, y
                    guideline.lineTo(rotateX, rotateY);
                    guideline.lineTo(targetX, targetY);

                    seriesGroup.addChild(itemId, guideline);
    ...
    _pChartPieSeriesControl._drawHighlight = function (item)
    {
        ...
        if (this._chart && this._chart._usepattern)
        {
            var idx = this._chart.getPatternIndex(item._index);
            var astyle = this._chart.getPattern(idx);

            highlightlinestyle = astyle.highlightlinestyle;
            highlightfillstyle = astyle.highlightfillstyle;
        }
        if (item)
        {
            ...
            if (highlightPathData)
            {
                ...
                highlightGroup.addChild("SeriesHighlightPieItem", slice);
