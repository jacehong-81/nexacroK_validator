...
if (!nexacro.ChartBubbleSeriesControl)
{
    ...
    _pChartBubbleSeriesControl._drawSeriesScatterPlot = function ()
    {
        ...
        if (this._chart && this._chart._usepattern)
        {
            ...
            fillstyle = astyle.fillstyle;
            selectlinestyle = astyle.normallinestyle;
            selectfillstyle = astyle.selectfillstyle;
            size = 15;
        }
    ...
    {
        var valuecolumn, value2column, value3column,
        ...
        this._mindata = nexacro._GraphicsLib.arrMin(bubbleData);
        this._maxdata = nexacro._GraphicsLib.arrMax(bubbleData);
    ...
    _pChartBubbleSeriesControl._drawScatterPlot = function (x, y, radius, axisx, axisy, pointshape, _pointshape, linestyle, fillstyle, opacity, index, item)
    {
        ...
        var chart = this._chart,
            ...
            effect = this._chart_aniframe_obj,
            banimationclip = false,

            highlightGroup = chart._highlightGroup;
        x = +x;
        y = +y;
        if (x < axisx._min || x > axisx._max || y < axisy._min || y > axisy._max)
        {
            return;
        }
    ...
    _pChartBubbleSeriesControl._drawBubble = function (x, y, data, radius, linestyle, fillstyle, opacity, index, item)
    {
        ...
        if (!axisx || !axisy || x < axisx._min || x > axisx._max || y < axisy._min || y > axisy._max)
        {
            return;
        }
        ...
        if (item)
        {
            ...
            if (!highlightitem)
            {
                ...
                circle._item = item;
                highlightGroup.addChild(seriesId, circle);
            }
        }
        else
        {
            ...
            if (!circle)
            {
                ...
                seriesGroup.addChild(seriesId, circle);
            }
            else
            {
                circle.set_x(cx);
        ...
        if (circle !== undefined)
        {
            ...
            if (board)
            {
                ...
                circle.setClipRect(-cx, -cy, boardWidth, boardHeight);
            }
    ...
    _pChartBubbleSeriesControl = null;
}