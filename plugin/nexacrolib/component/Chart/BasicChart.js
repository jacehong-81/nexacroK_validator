...
if (!nexacro.BasicChart)
{
    ...
    _pBasicChart.on_apply_stacktype = function ()
    {
        ...
        for (i = 0; i < seriesset.length; i++)
        {
            ...
            if (s)
            {
                ...
                if (stacktype == "percent") ispercent = true;
            }
        }
        for (i = 0; i < seriesset.length; i++)
        {
            ...
            if (s)
            {
                ...
                if (s._stacktype == "percent") ispercent = true;
    ...
    {
        var barindex = []; //0은 bar index, 1은 stackindex
        var xindex = -1;
        var yindex = -1;
        var stackgroupid;
        if (this._stackGroupingArray && s)
    ...
    _pBasicChart._setDatapoint = function ()
    {
        ...
        if (this.categoryaxis && this.categoryaxis._isTimeAxis)
        {
            ...
            if (this.categoryaxis._resizeClient) this._reset = true;
        ...
        if (this._barVisibleSeriesCnt > 1 && this._bargrouping /*&& (!this.stacktype || this.stacktype == "none")*/)
        {
    ...
    _pBasicChart._setStackPercent = function (series)
    {
        ...
        this._stackPercents = [];
        nexacro._GraphicsLib.arrForEach(data, function (d, i)
        {
    ...
    _pBasicChart._getSumsStackPercent = function (stackgroupseries)
    {
        ...
        nexacro._GraphicsLib.arrForEach(series, function (s, i)
        {
            var keyIdx = 0,
                valueIdx = 1,
                format,
            ...
            nexacro._GraphicsLib.arrForEach(s._data, function (d, j)
            {
                var value = 0,
                    key;
    ...
    _pBasicChart._setGroupColumnDatapoints = function (series)
    {
        var rotateaxis = this.rotateaxis,
            ...
            barVisibleCnt = this._getVisibleStackGroupingLength(),
        ...
        function getAxeMinMaxValues(datapoints)
        {
            ...
            if (rotateaxis)
            {
                if (nexacro._isNumber(ymin))
                {
                    minMaxValues[0] = Number(ymin);
                }

                if (nexacro._isNumber(ymax))
                {
            ...
            {
                if (nexacro._isNumber(xmin))
                {
                    minMaxValues[0] = Number(xmin);
                }

                if (nexacro._isNumber(xmax))
                {
...
if (!nexacro.ChartBasicSeriesControl)
{
    ...
    _pChartBasicSeriesControl.on_apply_barvisible = function ()
    {
        ...
        var selecttype = this.selecttype,
            bargrouping = this._chart._bargrouping,
    ...
    _pChartBasicSeriesControl.on_apply_linevisible = function (linevisible)
    {
        var barvisible = this.barvisible,
            ...
            stacktype = this._stacktype || this._chart.stacktype;
        ...
        for (i = 0; i < itemLength; i++)
        {
            if (seriesGroup)
            {
                ...
                if (barvisible)
                {
                    ...
                    if (item)
                    {
                        re = seriesGroup.removeChild(itemID);
                        if (re._series)
                        {
    ...
    _pChartBasicSeriesControl._drawSeriesBars = function ()
    {
        ...
        if (this._chart._getVisibleStackGroupingLength() > 1 && this._chart._bargrouping /*&& (!stacktype || stacktype == "none")*/ && this._groupbarwidth != null)
        {
            this._barsize = this._chart._toGroupBarWidth(this._groupbarwidth);
            barwidth = this._barsize;

        }
        else if (this._chart._getVisibleStackGroupingLength() > 1 && this._chart._bargrouping /*&& (!stacktype || stacktype == "none")*/ && this._groupbarwidth == null)
        {
        ...
        if ((linetype == "step" && this.linevisible) || this._chart._isstepline/*&& (!stacktype || stacktype == "none")*/)
        {
            ps += 3;
        }
    ...
    _pChartBasicSeriesControl._drawSeriesCurveLines = function ()
    {
        ...
        var cp = [],
            ...
            x1, x2, y1, y2,
            ps = datapoints.pointsize,
            points = datapoints.points.slice(0),
            len = points.length,
            pts = [];
        var skipmoves = [];
        var skipindex = 0;
        ...
        if (this._chart && this._chart._usepattern)
        {
            idx = this._chart.getPatternIndex(this._configIndex);
            var astyle = this._chart.getPattern(idx);
            linestyle = astyle.linestyle;
            lineareafillstyle = astyle.fillstyle;
            selectlinestyle = astyle.selectlinestyle;
            selectlineareafillstyle = astyle.selectfillstyle;
        }
        // 여기까지
        for (i = 0; i < length; i++)
        {
        ...
        if (this._chart._isstepline && linetype != "step") ps += 3;
        for (idx = 0; idx < len; idx += ps)
        {
            ...
            if (y1 == null || y2 == null)
            {
                if (x1 != null)
                {
                    if (lineareavisible)
                    {
                        if (y1 == null) y1 = yaxis._min;
                        if (y2 == null) y2 = yaxis._min;
            ...
            if (this._chart._getVisibleStackGroupingLength() > 1 && this._chart._bargrouping && this._barwidth /*&& stacktype == "none"*/ && this.barvisible)
            {
                if (!rotateaxis)
                {
        ...
        for (idx = 2; idx < len - 3; idx += 2)
        {
            ...
            addCurveLine('bezier', pts.slice(idx, idx + 4), cp.slice(2 * idx - 2, 2 * idx + 2));
        }
    ...
    _pChartBasicSeriesControl._drawSeriesLines = function ()
    {
        ...
        if (isselectitem)
        {
            if (lineareavisible)
            {
                this._drawArea(datapoints, categoryaxis, valueaxis, selectlineareafillstyle, selectlineareaopacity);
            }
        ...
        else
        {
            if (lineareavisible)
            {
                this._drawArea(datapoints, categoryaxis, valueaxis, lineareafillstyle, lineareaopacity);
            }
    ...
    _pChartBasicSeriesControl._drawSeriesPoints = function ()
    {
        ...
        if (this._chart && this._chart._usepattern)
        {
            var idx = this._chart.getPatternIndex(this._configIndex);
            var astyle = this._chart.getPattern(idx);
            pointlinestyle = astyle.normallinestyle;
            pointfillstyle = astyle.fillstyle;
            selectpointlinestyle = astyle.normallinestyle;
            selectpointfillstyle = astyle.selectfillstyle;
            pointsize = 15;
        }
    ...
    _pChartBasicSeriesControl._drawPoint = function (x, y, radius, axisx, axisy, pointshape, _pointshape, pointlinestyle, pointfillstyle, pointopacity, index, item)
    {
        ...
        if (item)
        {
            ...
            if (!highlightitem)
            {
                ...
                highlightGroup.addChild(seriesId, point);
        ...
        else
        {
            if (seriesGroup)
            {
                ...
                else
                {
                    ...
                    seriesGroup.addChild(seriesId, point);
                }
        ...
        if (point !== undefined)
        {
            ...
            if (board)
            {
                ...
                {
                    point.setClipRect(0, 0, boardWidth, boardHeight);
                }
                else if (pointshape == "square")
                    point.setClipRect(-point.x, -point.y, boardWidth, boardHeight);
                else
                    point.setClipRect(-cx, -cy, boardWidth, boardHeight);
    ...
    _pChartBasicSeriesControl._setLineAreaClip = function (path)
    {
        var rotateaxis = this._chart.rotateaxis,
            ...
            boardHeight = 0,
            series = this,
            borderWidth = this._chart._boardBorderWidth || 1,
            borderHeight = this._chart._boardBorderHeight || 1;
        ...
        if (board)
        {
            ...
            if (rotateaxis)
            {
                ...
                path.setClipRect(0, tickstartgap, boardWidth, boardHeight + 2);
            }
            else
            {
                axis = series._xaxis;
                ...
                path.setClipRect(tickstartgap, 0, boardWidth + 2, boardHeight);
            }
    ...
    _pChartBasicSeriesControl._drawLine = function (datapoints, xoffset, yoffset, axisx, axisy, linestyle, lineopacity, Ishighlight)
    {
        ...
        if (Ishighlight)
        {
            ...
            itemid = this._configIndex + " SeriesHighlightLineItem_0";
        ...
        if (this._chart._isstepline && this.linetype != "step") ps += 3;
        for (var i = ps; i < points.length; i += ps)
        {
            var x1, y1, x2, y2;

            if (this._chart._bargrouping && /*(!this._chart.stacktype || this._chart.stacktype == "none") &&*/ this.linetype == "step")
            {
                if (i % 6 == 0)
                {
                    x1 = points[i];
            ...
            if (y1 == null || y2 == null)
            {
                if (this.lineareavisible)
                {
                    if (y1 == null) y1 = axisy._min;
                    if (y2 == null) y2 = axisy._min;
                }
                else
                    continue;
            }
            ...
            if (x1 != prevx || y1 != prevy)
            {
                ...
                szpathdata += "M" + startPointX + " " + startPointY + " ";
            ...
            szpathdata += "L" + endPointX + " " + endPointY + " ";
        ...
        else
        {
            ...
            {
                this._itemCnt++;
                seriesGroup.addChild(itemid, path);
            }
        }
        path.setPathData(szpathdata);
    ...
    {
        //trace(datapoints.points.toString());
        ...
        while (true)
        {
            ...
            if (this._chart._getVisibleStackGroupingLength() > 1 && this._chart._bargrouping /*&& this.barvisible*/ && this._barwidth /*&& stacktype == "none"*/ && this.barvisible)
            {
                if (!rotateaxis)
                {
                    shiftPointX = this._barwidth / 2;
                ...
                y1Point = axisy.p2c(/*points[i - ps + ypos]*/y1) + shiftPointY;
                isbargrouping = true;
            }
            else
            {
                x1Point = axisx.p2c(x1);
                y1Point = axisy.p2c(/*points[i - ps + ypos]*/y1);
            }
            ...
            if (/*y1 && y2 && */stepend) // Line path가 그려지고 난 다음 마지막 선 그리기 
            {
                ...
                if (!rotateaxis)
                {
                    ...
                    startY1 = y1Point;//axisy.p2c(axisy._min)  + shiftPointY;
        ...
        {
            this._itemCnt++;
            this._chart._seriesGroup.addChild(itemid, area);
        }
        area.closePath();
    ...
    _pChartBasicSeriesControl._drawCurveLine = function (points, linestyle, lineopacity, Ishighlight, skipmoves)
    {
        ...
        {
            path = new nexacro.GraphicsPaths();
            itemid = this._configIndex + " SeriesHighlightCurveLineItem_0";
        }
        else
        {
        ...
        szpathdata += "M" + points[0][0] + " " + points[0][1] + " ";
        ...
        for (var i = 0; i < plength; i++)
        {
            ...
            else if (type == "quadraticCurveTo")
            {
                ...
                //path.quadraticCurveTo(x1, y1,cx, cy);
                szpathdata += "Q" + x1 + " " + y1 + " " + cx + " " + cy + " ";
            ...
            else if (type != "quadraticCurveTo" && i != (plength - 2))
            {
                ...
                //path.bezierCurveTo(x1, y1, cx, cy, x2, y2);
                szpathdata += "C" + x1 + " " + y1 + " " + cx + " " + cy + " " + x2 + " " + y2 + " ";
            }
        }
        ...
        else
        {
            ...
            if (bCreate)
            {
                this._chart._seriesGroup.addChild(itemid, path);
                this._itemCnt++;
            }
        }
        path.setPathData(szpathdata);
    ...
    _pChartBasicSeriesControl._drawCurveArea = function (points, vpoints,/*endposf,endposl,*/ lineareafillstyle, lineareaopacity)
    {
        ...
        if (plength <= 0) return area;
        //area.set_strokepen("3px solid red");
        area.moveTo(points[0][0], points[0][1]);


        // 자기 자신의 arealine을 그리는 부분 
        for (i = 0; i < plength; i++)
        {
            // points[i][2] 포인트 6개 존재
            x1 = points[i][2][0];
            ...
            {
                area.quadraticCurveTo(x1, y1, cx, cy);
            }
            else if (type != "quadraticCurveTo" && i != (plength - 2))
            {
                area.bezierCurveTo(x1, y1, cx, cy, x2, y2);
            }
        }
    ...
    _pChartBasicSeriesControl._drawPointItemText = function (cx, cy, item)
    {
        ...
        if (!nexacro._isNull(itemText))
        {
            ...
            var itemtextPosition = this.pointitemtextposition,
                itemtextGap = this.pointitemtextgap;
    ...
    _pChartBasicSeriesControl._showBarHighlight = function (item)
    {
        ...
        if (!barHighlight)
        {
            ...
            if (this._chart.seriesset.length > 1 && this._chart._bargrouping /*&& (!stacktype || stacktype == "none")*/ && this._groupbarwidth != null)
            {
                this._barsize = this._chart._toGroupBarWidth(this._groupbarwidth);
                barwidth = this._barsize;
            }
            else if (this._chart.seriesset.length > 1 && this._chart._bargrouping /*&& (!stacktype || stacktype == "none")*/ && this._groupbarwidth == null)
            {
                barwidth = this._chart._barsize;
            }
            else
    ...
    _pChartBasicSeriesControl._hideBarHighlight = function (item)
    {
        ...
        if (barHighlight && !nexacro._GraphicsLib.isEmpty(barHighlight.parent))
        {
            ...
            this._chart._highlightGroup.removeChild(barHighlight.id);
    ...
    _pChartBasicSeriesControl._showPointHighlight = function (item)
    {
        ...
        if (!pointHighlight)
        {
            ...
            if (this._chart && this._chart._usepattern)
            {
                var idx = this._chart.getPatternIndex(this._configIndex);
                var astyle = this._chart.getPattern(idx);
                highlightpointlinestyle = astyle.highlightlinestyle;
                highlightpointfillstyle = astyle.highlightfillstyle;
            }
    ...
    _pChartBasicSeriesControl._hidePointHighlight = function (item)
    {
        ...
        {
            this._chart._chageGroupObject(this._chart._seriesGroup, this._chart._highlightGroup, this._itemtextlist, true);
            this._chart._highlightGroup.removeChild(pointHighlight.id);
    ...
    _pChartBasicSeriesControl._hideLineHighlight = function (item)
    {
        ...
        {
            this._chart._chageGroupObject(this._chart._seriesGroup, this._chart._highlightGroup, this._itemtextlist, true);
            this._chart._highlightGroup.removeChild(lineHighlight.id);
    ...
    _pChartBasicSeriesControl._drawLineHighlight = function (item)
    {
        ...
        if (this._chart && this._chart._usepattern)
        {
            idx = this._chart.getPatternIndex(this._configIndex);
            var astyle = this._chart.getPattern(idx);
            highlightlinestyle = astyle.highlightlinestyle;
        }
        if (this.linetype == "curve")
        {
            ...
            highlightGroup.addChild(path._makeid, path);
            path._makeid = "";
    ...
    _pChartBasicSeriesControl._setStackDatapoints = function ()
    {
        ...
        var ps = datapoints.pointsize,
            ...
            withsteps = (withlines && this.linetype == "step") || this._chart._isstepline,
            fromgap = true,
    ...
    _pChartBasicSeriesControl = null;
}
