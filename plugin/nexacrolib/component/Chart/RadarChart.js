...
if (!nexacro.RadarChart)
{
    ...
    _pRadarChart.categoryaxis = null; // readonly
    _pRadarChart.valueaxes = null;    // readonly
    ...
    //===============================================================
    // nexacro.RadarChart : Create & Update
    //===============================================================
    ...
    _pRadarChart.showValueaxis = function (id)
    {
        ...
        if (axis != this.valueaxes[0]) return;
        if (axis)
        {
    ...
    //===============================================================
    // nexacro.RadarChart : Events
    //===============================================================


    //===============================================================
    // nexacro.RadarChart : Logical part
    //===============================================================
    ...
    _pRadarChart._setDatapoint = function ()
    {
        ...
        for (var i = 0; i < seriesset.length; i++)
        {
            ...
            if (s)
            {
                ...
                this._setSeriesDatapoints(s); //make angle ,percent
    ...
    //===============================================================
    // nexacro.RadarChart : Util Function
    //===============================================================
    ...
    _pRadarChart._setAxislabelChangeInBoardAreaPos = function (item)
    {
        ...
        if (item && item._type_name == "GraphicsText")
        {
            var labelBoundRect = item.getBoundRect(),
                ...
                rectx = this._boardRectLeft,
                recty = this._boardRectTop,
                rectwidth = this._boardWidth + rectx,
                rectheight = this._boardHeight + recty,


                textW = labelBoundRect.width,
                textH = labelBoundRect.height,
                pos = item.getBoundRect().getCenterPoint();
            var cx = pos.x;
            var cy = pos.y;
...
if (!nexacro.ChartRadarCategoryAxisControl)
{
    ...
    //===============================================================
    // nexacro._pChartRadarCategoryAxisControl : Logical part
    //===============================================================
    _pChartRadarCategoryAxisControl._create = function ()
    {
        ...
        this._group.addChild(this.id + "_ChartAxisBoardLineGroup", this._boardLineGroup);
        ...
        if (this.parent._seriesGroup)
        {
            ...
            this._graphicsControl.insertChild(index, this.id + "_ChartAxisGroup", this._group);
        }
        else
        {
    ...
    _pChartRadarCategoryAxisControl._setData = function (clientWidth, clientHeight)
    {
            ...
            || this._changedTickLabelRotate || this._changedTickLabelStyle)
        {
            for (var i = 0; i < ticks.length; i++)
            {
                ...
                {
                    // guidepath 생성 
                    axisLine = new nexacro.GraphicsPath();

                    this._boardLineGroup.addChild("ChartAxisTickBoardLine" + i, axisLine);
    ...
    _pChartRadarCategoryAxisControl._arrangeTickGroup = function (width, height)
    {
        ...
        var chart = this.parent,
            ...
            categoryaxis = this,
            axislinetype = chart.radartype || "polygon",
        ...
        if (this._axisLine && ticks.length > 0)
        {
            for (var j = 0; j < categorylength; j++)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        this._axisLine.arcTo(endX, endY, range, range, 0, 1, 0);
                    }
            ...
            if (bstartline)
            {
                ...
                {
                    this._axisLine.arcTo(startX, startY, range, range, 0, 1, 0);
                }
            }
        }
    ...
    _pChartRadarCategoryAxisControl._arrangeLabelGroup = function ()
    {
        ...
        function positionlefttop(itemText,cx,cy,rotate,width)
        {
            ...
            var labelBoundRect = itemText.getBoundRect(),
                textW = labelBoundRect.width,
                textH = labelBoundRect.height,
    ...
    _pChartRadarCategoryAxisControl = null;

}
if (!nexacro.ChartRadarValueAxisControl)
{
    //==============================================================================
    // nexacro.ChartRadarValueAxisControl
    //==============================================================================
    ...
    // 신규 propertes
    _pChartRadarValueAxisControl.axislineindex = "0";  //0 ~~~ (categoryaxis rowcount -1)
    _pChartRadarValueAxisControl._axislineindex = 0;
    //_pChartRadarValueAxisControl.axislinetype = "polygon";  //circle
    ...
    //===============================================================
    // nexacro._pChartRadarValueAxisControl : Logical part
    //===============================================================
        ...
        for (var i = 0; i < ticks.length; i++)
        {
            ...
            for (var j = 0; j < categorylength; j++)
            {
                ...
                else
                {
                    ...
                    {
                        axisLine.arcTo(endX, endY, range, range, 0, 1, 0);
                    }
            ...
            if (bstartline)
            {
                ...
                {
                    axisLine.arcTo(startX, startY, range, range, 0, 1, 0);
                }
            }
    ...
    _pChartRadarValueAxisControl._checkinterval = function (width, height)
    {
        var chart = this.parent,
            ticks,
            maxRadius = Math.min(width, height) / 2,  // boardrect arrange 처리 전이므로 
            radius = 0,
            range = 0;
    ...
    _pChartRadarValueAxisControl._setupTickGeneration = function (width, height)
    {
        ...
        {
            // AutoTick 계산 (Radar Chart의 마지막 구간 처리) 
            ticks = [];
            var start = this._floorInBase(this._min, tickinterval),
                i = 0,
                v = Number.NaN,
                prev;
    ...
    _pChartRadarValueAxisControl = null;
...
{
    //==============================================================================
    // nexacro.ChartRadarSeriesEventInfo
    //==============================================================================


    //==============================================================================
    // nexacro.ChartRadarSeries
    //==============================================================================
    ...
    //============================================================
    // nexacro.ChartRadarSeries : Properties
    //============================================================
    ...
    //============================================================
    // nexacro.ChartRadarSeries : Methods
    //============================================================

    //============================================================
    // nexacro.ChartRadarSeries : Logical part
    //============================================================	
    _pChartRadarSeriesControl._applyPropertySeries = function (type, style, value, select)
    {
        ...
        if (seriesGroup)
        {
            ...
            {
                if (type == "Line" && this.lineareavisible == true) type = "Area";
    ...
    _pChartRadarSeriesControl._hideLineAreaHighlight = function (item)
    {
        ...
        {
            this._chart._chageGroupObject(this._chart._seriesGroup, this._chart._highlightGroup, this._itemtextlist, true);
            this._chart._highlightGroup.removeChild(lineareaHighlight.id);
    ...
    _pChartRadarSeriesControl._drawLineAreaHighlight = function (item)
    {
        ...
        var highlightlineareafillstyle = this.highlightlineareafillstyle || this._highlightcolor,
            highlightlineareaopacity = this.highlightlineareaopacity,
            highlightlinestyle = "1px solid " + highlightlineareafillstyle,
            highlightlineopacity = this.highlightlineopacity,
            datapoints = this._datapoints,
            categoryaxis = this._chart.categoryaxis,
            valueaxis = this._chart.valueaxes[0],
        ...
        if (this._chart && this._chart._usepattern)
        {
            ...
            var astyle = this._chart.getPattern(idx);
            highlightlinestyle = astyle.highlightlinestyle;
            highlightlineareafillstyle = astyle.highlightfillstyle;
    ...
    _pChartRadarSeriesControl._drawLine = function (datapoints, xoffset, yoffset, categoryaxis, valueaxis, linestyle, lineopacity, Islineareavisible, Ishighlight)
    {
        var points = datapoints.points.slice(0),
            ...
            lineareavisible = Islineareavisible,
            bstartline = false;
        xoffset += -this._chart._boardRectLeft;
        yoffset += -this._chart._boardRectTop;
        ...
        if (Ishighlight)
        {
            path = new nexacro.GraphicsPath();
            if (!lineareavisible)
            {
                seriesid = this._configIndex + " SeriesHighlightLineItem_0";
            }
            else
            {
                seriesid = this._configIndex + " SeriesHighlightAreaItem_0";
            }
        }
        else
        {
        ...
        if (Ishighlight)
        {
            ...
            this._chart._highlightGroup.addChild(seriesid, path);
        }
        else
        {
            path._series = this;
            ...
            {
                this._itemCnt++;
                this._chart._seriesGroup.addChild(seriesid, path);
            }
    ...
    _pChartRadarSeriesControl = null;
}
