...
if (!nexacro._GraphicsMatrix)
{
    ...
    {
        if (nexacro._isNumber(v) && this._p_scaleX != v)
        {
            this._p_scaleX = v;
    ...
    {
        if (nexacro._isNumber(v) && this._p_shearY != v)
        {
            this._p_shearY = v;
    ...
    {
        if (nexacro._isNumber(v) && this._p_shearX != v)
        {
            this._p_shearX = v;
    ...
    {
        if (nexacro._isNumber(v) && this._p_scaleY != v)
        {
            this._p_scaleY = v;
    ...
    {
        if (nexacro._isNumber(v) && this._translateX != v)
        {
    ...
    {
        if (nexacro._isNumber(v) && this._translateY != v)
        {
...
if (!nexacro._GraphicsSize)
{
    ...
    {
        if (nexacro._isNumber(v) && this._p_width != v)
        {
            this._p_width = v;
        }
    };
    ...
    {
        if (nexacro._isNumber(v) && this._p_height != v)
        {
            this._p_height = v;
        }
    };
...
if (!nexacro.Graphics)
{
    ...
    _pGraphicsControl.on_created_contents = function (win)
    {
        ...
        if (layer)
        {
            ...
            if (nexacro._AccessibilityStyles.length == 0 && this._env._p_enableaccessibility)
            {
