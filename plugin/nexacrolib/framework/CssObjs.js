	...
	nexacro._BorderObject = function (v)
	{
		if (v && (typeof (v) == "string") && v != "none")
		{
			...
			if (val)
			{
				...
				// this.right.rtlvalue = this.left.value;
				//  this.left.rtlvalue = this.right.value;
			}
		}
	};
	...
	nexacro._BackgroundObject = function (v, target)
	{
		if (v && (typeof (v) == "string"))
		{
			...
			if (val)
			{
				...
				/*if (this.rtlvalue)
				{
					if (this.rtlvalue.indexOf("left") > 0)
						this.rtlvalue = nexacro.replaceAll(this.rtlvalue, "left", "right");
					else if (this.rtlvalue.indexOf("right") > 0)
						this.rtlvalue = nexacro.replaceAll(this.rtlvalue, "right", "left");
				}*/
